...
class FarmController extends Controller
{
    ...
    public function adminUpdate(Request $request, Farm $farm): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'referenceNo' => 'sometimes|required|string|max:255|unique:farms,referenceNo,' . $farm->id,
            'regionalRegNo' => 'sometimes|nullable|string|max:255',
            'name' => 'sometimes|required|string|max:255',
            'size' => 'sometimes|required|integer',
            'sizeUnit' => 'sometimes|nullable|in:acre,hectare,square_meter,square_kilometer',
            'latitudes' => 'sometimes|nullable|string|max:255',
            'longitudes' => 'sometimes|nullable|string|max:255',
            'physicalAddress' => 'sometimes|required|string',
